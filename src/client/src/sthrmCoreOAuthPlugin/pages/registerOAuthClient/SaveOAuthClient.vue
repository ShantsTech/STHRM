      ...
      <oxd-form :loading="isLoading" @submitValid="onSave">
        ...
        <oxd-form-row>
          <oxd-grid :cols="1" class="sthrm-full-width-grid">
            <oxd-text tag="span" class="sthrm-link">
              API Documentation:
              <a
                class="sthrm-link-url"
                href="https://sthrm.github.io/sthrm-api-doc"
              >
                https://sthrm.github.io/sthrm-api-doc
              </a>
            </oxd-text>
          </oxd-grid>
        </oxd-form-row>
        <oxd-form-row>
          <oxd-grid :cols="1" class="sthrm-full-width-grid">
            <oxd-text tag="span" class="sthrm-link">
              ...
              <a
                class="sthrm-link-url"
                href="https://github.com/sthrm/api-sample-app-php"
              >
                https://github.com/sthrm/api-sample-app-php
              </a>
            </oxd-text>
          </oxd-grid>
        </oxd-form-row>
