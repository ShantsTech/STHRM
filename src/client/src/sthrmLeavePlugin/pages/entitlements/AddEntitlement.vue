      ...
      <oxd-form :loading="isLoading" @submitValid="onSave">
        ...
        <oxd-form-row v-else>
          <oxd-grid :cols="3" class="sthrm-full-width-grid">
            ...
            <oxd-grid-item class="sthrm-leave-entitled">
              <oxd-text class="sthrm-leave-entitled-text" type="subtitle-2">
                {{
...
import LeaveTypeDropdown from '@/sthrmLeavePlugin/components/LeaveTypeDropdown';
import LeavePeriodDropdown from '@/sthrmLeavePlugin/components/LeavePeriodDropdown';
import EntitlementUpdateModal from '@/sthrmLeavePlugin/components/EntitlementUpdateModal';
import EntitlementBulkUpdateModal from '@/sthrmLeavePlugin/components/EntitlementBulkUpdateModal';
import EntitlementNoMatchModal from '@/sthrmLeavePlugin/components/EntitlementNoMatchModal';
