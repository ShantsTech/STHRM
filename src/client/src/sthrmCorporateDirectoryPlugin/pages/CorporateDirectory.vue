...
<template>
  <div class="sthrm-background-container">
    ...
    <div class="sthrm-corporate-directory">
      <div class="sthrm-paper-container">
        ...
        <div class="sthrm-bottom-container"></div>
      </div>

      <div
        v-if="isEmployeeSelected && isMobile === false"
        class="sthrm-corporate-directory-sidebar"
      >
        <oxd-grid-item>
...
import SummaryCard from '@/sthrmCorporateDirectoryPlugin/components/SummaryCard';
import EmployeeDetails from '@/sthrmCorporateDirectoryPlugin/components/EmployeeDetails';
import SummaryCardDetails from '@/sthrmCorporateDirectoryPlugin/components/SummaryCardDetails';
...
export default {
  ...
  computed: {
    ...
    oxdGridClasses() {
      return {
        'sthrm-container': true,
        'sthrm-container-min-display': this.isEmployeeSelected,
      };
    },
    colSize() {
