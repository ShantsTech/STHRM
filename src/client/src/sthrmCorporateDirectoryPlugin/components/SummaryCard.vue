...
<template>
  <oxd-sheet :gutters="false" class="sthrm-directory-card">
    <div
      v-show="showBackButton"
      class="sthrm-directory-card-top"
    ...
    <div
      ...
      class="sthrm-directory-card-body"
    >
      <oxd-icon
        class="sthrm-directory-card-icon"
        name="geo-alt-fill"
      ></oxd-icon>
      <div>
        <oxd-text
...
import ProfilePicture from '@/sthrmCorporateDirectoryPlugin/components/ProfilePicture';
...
export default {
  ...
  computed: {
    ...
    cardTitleClasses() {
      return {
        'sthrm-directory-card-header': true,
        '--break-words': !this.hasDefaultSlot,
      };
    },
    cardSubTitleClasses() {
      return {
        'sthrm-directory-card-subtitle': true,
        '--break-words': !this.hasDefaultSlot,
      };
    },
    cardDescriptionClasses() {
      return {
        'sthrm-directory-card-description': true,
        '--break-words': !this.hasDefaultSlot,
      };
    },
  },
