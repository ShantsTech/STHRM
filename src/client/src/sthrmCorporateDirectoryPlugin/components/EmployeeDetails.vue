...
<template>
  ...
  <div
    v-show="employeeWorkEmail || employeeWorkTelephone"
    class="sthrm-directory-card-rounded-body"
  >
    <div v-show="employeeWorkTelephone" class="sthrm-directory-card-icon">
      <oxd-icon-button
    ...
    <div v-show="employeeWorkEmail" class="sthrm-directory-card-icon">
      <oxd-icon-button
        display-type="danger"
        name="envelope-fill"
  ...
  <div
    ...
    class="sthrm-directory-card-hover"
    @mouseleave="showTelephoneClip = false"
    @mouseover="showTelephoneClip = true"
  >
    <div class="sthrm-directory-card-hover-body">
    ...
    <div
      class="sthrm-directory-card-hover-body sthrm-directory-card-hover-icon"
    >
      <oxd-icon-button
