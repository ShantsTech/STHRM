...
<template>
  <oxd-form
    ...
    :class="
      isLoading
        ? 'sthrm-system-check-form-loading'
        : 'sthrm-system-check-form'
    "
  >
    <div class="sthrm-system-check">
      <oxd-text tag="h5" class="sthrm-system-check-title">
        System Check
      </oxd-text>
      <br />
      <oxd-text class="sthrm-system-check-content">
      ...
      ></flex-table>
      <oxd-form-actions class="sthrm-system-check-action">
        <oxd-button
...
import FlexTable from '@/sthrmSystemCheckPlugin/components/FlexTable';
export default {
