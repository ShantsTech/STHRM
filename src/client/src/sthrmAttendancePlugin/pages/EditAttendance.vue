    ...
    <div class="sthrm-card-container">
      ...
      <div class="sthrm-paper-container">
        <oxd-form :loading="isLoading" @submitValid="onSave">
          <oxd-grid :cols="2" class="sthrm-full-width-grid no-gap">
            <oxd-grid-item>
...
import TimezoneDropdown from '@/sthrmAttendancePlugin/components/TimezoneDropdown.vue';
