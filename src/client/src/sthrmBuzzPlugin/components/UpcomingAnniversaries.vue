...
<template>
  <div class="sthrm-buzz-anniversary">
    <oxd-text type="card-title" class="sthrm-buzz-anniversary-title">
      {{ $t('buzz.upcoming_anniversaries') }}
    </oxd-text>
    <div
      class="sthrm-buzz-anniversary-content"
      :class="{'--show-more': anniversariesCount > 5}"
    >
      <div
        v-for="anniversary in anniversaries"
        :key="anniversary"
        class="sthrm-buzz-anniversary-item"
      >
        <div class="sthrm-buzz-anniversary-profile">
          <profile-image :employee="anniversary"></profile-image>
          <div class="sthrm-buzz-anniversary-profile-details">
            <oxd-text tag="p" class="sthrm-buzz-anniversary-emp-name">
              {{ anniversary.empName }}
            </oxd-text>
            <oxd-text tag="p" class="sthrm-buzz-anniversary-job-details">
              {{ anniversary.jobTitle }}
            </oxd-text>
          </div>
        </div>
        <div class="sthrm-buzz-anniversary-duration">
          <img
            alt="year celebration"
            class="sthrm-buzz-anniversary-year-celebration"
            :src="celebrationPic"
          />
          <div class="sthrm-buzz-anniversary-durations-text">
            <oxd-text tag="p" class="sthrm-buzz-anniversary-duration-years">
              {{ anniversary.anniversaryYear }} <br />
              {{ $t('buzz.n_year', {yearsCount: anniversary.anniversaryYear}) }}
            </oxd-text>
            <oxd-text tag="p" class="sthrm-buzz-anniversary-duration-date">
              {{ anniversary.joinedDate }}
            </oxd-text>
          </div>
        </div>
      </div>
      <div v-if="isEmpty" class="sthrm-buzz-anniversary-nocontent">
    ...
    <div
      ...
      class="sthrm-buzz-anniversary-footer"
    >
