...
<template>
  ...
  >
    ...
    <oxd-form :loading="loading" @submitValid="onSubmit">
      <div class="sthrm-buzz-post-modal-header">
        <profile-image :employee="employee"></profile-image>
        <div class="sthrm-buzz-post-modal-header-text">
          <slot name="header"></slot>
        </div>
      </div>
      <slot></slot>
      <oxd-form-actions class="sthrm-buzz-post-modal-actions">
        <oxd-button
          type="submit"
          :disabled="disabled"
