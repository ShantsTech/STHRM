...
<template>
  <div v-click-outside="onClose" class="sthrm-buzz-stats">
    <div class="sthrm-buzz-stats-row">
      <oxd-icon
        name="heart-fill"
        class="sthrm-buzz-stats-like-icon"
      ></oxd-icon>
...
import PostStatsModal from '@/sthrmBuzzPlugin/components/PostStatsModal.vue';
...
export default {
  ...
  computed: {
    ...
    likesClasses() {
      return {
        'sthrm-buzz-stats-active': this.post.stats?.numOfLikes > 0,
      };
    },
    sharesClasses() {
      return {
        'sthrm-buzz-stats-active': this.post.stats?.numOfShares > 0,
      };
    },
  },
