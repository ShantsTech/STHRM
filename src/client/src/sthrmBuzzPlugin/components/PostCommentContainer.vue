...
<template>
  <div class="sthrm-buzz-comment">
    <div class="sthrm-buzz-comment-add">
    ...
    <oxd-text
      v-if="total > 4"
      tag="p"
      class="sthrm-buzz-comment-readmore"
...
import PostComment from '@/sthrmBuzzPlugin/components/PostComment';
