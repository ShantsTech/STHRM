...
<template>
  <oxd-sheet class="sthrm-buzz-create-post">
    <div class="sthrm-buzz-create-post-header">
      <profile-image :employee="employee"></profile-image>
      <div class="sthrm-buzz-create-post-header-text">
    ...
    <oxd-divider />
    <div class="sthrm-buzz-create-post-actions">
      <oxd-glass-button
        icon="cameraglass"
...
import ShareVideoModal from '@/sthrmBuzzPlugin/components/ShareVideoModal';
import SharePhotoModal from '@/sthrmBuzzPlugin/components/SharePhotoModal';
