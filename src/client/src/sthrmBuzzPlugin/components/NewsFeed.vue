...
<template>
  <div class="sthrm-buzz-newsfeed">
    <oxd-text type="card-title" class="sthrm-buzz-newsfeed-title">
    ...
    <oxd-grid :cols="1" class="sthrm-buzz-newsfeed-posts">
      ...
      <oxd-grid-item
        ...
        class="sthrm-buzz-newsfeed-noposts"
      >
    ...
    <oxd-loading-spinner
      v-if="isLoading"
      class="sthrm-buzz-newsfeed-loader"
    />
  </div>
...
import PostBody from '@/sthrmBuzzPlugin/components/PostBody.vue';
import PostStats from '@/sthrmBuzzPlugin/components/PostStats.vue';
import CreatePost from '@/sthrmBuzzPlugin/components/CreatePost.vue';
import useInfiniteScroll from '@/core/util/composable/useInfiniteScroll';
import PostActions from '@/sthrmBuzzPlugin/components/PostActions.vue';
import useBuzzAPIs from '@/sthrmBuzzPlugin/util/composable/useBuzzAPIs';
import EditPostModal from '@/sthrmBuzzPlugin/components/EditPostModal.vue';
import PhotoCarousel from '@/sthrmBuzzPlugin/components/PhotoCarousel.vue';
import PostContainer from '@/sthrmBuzzPlugin/components/PostContainer.vue';
import SharePostModal from '@/sthrmBuzzPlugin/components/SharePostModal.vue';
import DeleteConfirmationDialog from '@ohrm/components/dialogs/DeleteConfirmationDialog';
import PostCommentContainer from '@/sthrmBuzzPlugin/components/PostCommentContainer.vue';
