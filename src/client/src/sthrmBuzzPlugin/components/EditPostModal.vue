...
<template>
  ...
  >
    ...
    <template v-if="data.originalPost">
      ...
      <oxd-text tag="p" class="sthrm-buzz-share-employee">
        {{ originalPost.employee }}
      </oxd-text>
      <oxd-text tag="p" class="sthrm-buzz-share-date">
        {{ originalPost.dateTime }}
      </oxd-text>
      <oxd-text
        v-if="originalPost.text"
        tag="p"
        class="sthrm-buzz-share-text"
      >
        {{ originalPost.text }}
      </oxd-text>
    </template>
