...
<template>
  ...
  <oxd-input-group v-if="fileSelected" :label="label">
    <div class="sthrm-file-current">
      <div class="sthrm-file-preview" @click="downloadFile">
        <oxd-icon class="sthrm-file-icon" name="file-earmark-text" />
        <oxd-text class="sthrm-file-name" tag="p" :title="file.filename">
          {{ file.filename }}
          <oxd-icon class="sthrm-file-download" name="download" />
        </oxd-text>
      </div>
      <div v-if="!disabled" class="sthrm-file-options">
        <oxd-input-field
          type="radio"
  ...
  >
    ...
    />
    <oxd-text class="sthrm-input-hint" tag="p">{{ hint }}</oxd-text>
  </div>
</template>
