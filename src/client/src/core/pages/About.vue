...
<template>
  ...
  >
    ...
    <oxd-divider />
    <div v-if="isLoading" class="sthrm-loader">
      <oxd-loading-spinner />
    </div>
    <oxd-grid v-else :cols="2" class="sthrm-about">
      <oxd-grid-item>
        <oxd-text tag="p" class="sthrm-about-title">
          {{ $t('general.company_name') }}:
        </oxd-text>
      </oxd-grid-item>
      <oxd-grid-item>
        <oxd-text tag="p" class="sthrm-about-text">
          {{ data.companyName }}
        </oxd-text>
      </oxd-grid-item>
      <oxd-grid-item>
