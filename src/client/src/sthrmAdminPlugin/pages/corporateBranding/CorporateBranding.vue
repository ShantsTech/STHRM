    ...
    <div class="sthrm-card-container">
      ...
      <oxd-form ref="formRef" :loading="isLoading" @submitValid="onFormSubmit">
        ...
        <oxd-form-row>
          <oxd-grid :cols="4" class="sthrm-full-width-grid">
            <oxd-grid-item>
              <div class="sthrm-sm-field">
                <oxd-text tag="p" class="sthrm-sm-field-label">
...
import InlineColorInput from '@/sthrmAdminPlugin/components/InlineColorInput';
