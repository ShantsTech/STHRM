...
import EditTranslationTable from '@/sthrmAdminPlugin/components/EditTranslationTable.vue';
import GroupListDropdown from '@/sthrmAdminPlugin/components/LanguageGroupListDropdown.vue';
