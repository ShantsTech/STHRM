  ...
  <div class="sthrm-background-container">
    <div class="sthrm-card-container">
      ...
      <oxd-form :loading="isLoading" @submitValid="onSave">
        ...
        <oxd-form-row>
          <oxd-text class="sthrm-sub-title">Working Hours*</oxd-text>
          <oxd-grid :cols="4" class="sthrm-full-width-grid">
            ...
            <oxd-grid-item>
              <oxd-input-group :label="$t('admin.duration_per_day')">
                <oxd-text class="sthrm-workshift-duration" tag="p">
...
import WorkShiftEmployeeAutocomplete from '@/sthrmAdminPlugin/components/WorkShiftEmployeeAutocomplete';
