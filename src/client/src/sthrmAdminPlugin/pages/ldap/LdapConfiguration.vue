  ...
  <div class="sthrm-background-container">
    <div class="sthrm-card-container">
      ...
      <oxd-form ref="formRef" :loading="isLoading">
        <oxd-text tag="p" class="sthrm-subtitle">
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="sthrm-full-width-grid">
            ...
            <oxd-grid-item class="sthrm-column-half">
              <oxd-input-field
        ...
        <oxd-divider class="sthrm-form-divider" />
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="sthrm-full-width-grid">
            <oxd-grid-item class="sthrm-ldap-switch">
              <oxd-text tag="p" class="sthrm-ldap-switch-text">
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="sthrm-ldap-grid">
            <oxd-grid-item class="sthrm-ldap-grid-header">
              <oxd-text tag="p">
                {{ $t('admin.field_in_sthrm') }}
              </oxd-text>
            </oxd-grid-item>
            <oxd-grid-item class="sthrm-ldap-grid-header">
              <oxd-text tag="p">
            ...
            <oxd-grid-item class="sthrm-ldap-grid-content">
              <oxd-text tag="p" class="oxd-input-field-required">
                {{ $t('general.first_name') }}
              </oxd-text>
              <oxd-icon class="sthrm-ldap-grid-icon" name="arrow-left" />
            </oxd-grid-item>
            <oxd-grid-item>
              <oxd-input-field
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="sthrm-full-width-grid">
            <oxd-grid-item class="sthrm-ldap-switch --offset-row-1">
              <oxd-text tag="p" class="sthrm-ldap-switch-text">
...
import LdapSyncConnection from '@/sthrmAdminPlugin/components/LdapSyncConnection';
import LdapTestConnectionModal from '@/sthrmAdminPlugin/components/LdapTestConnectionModal';
