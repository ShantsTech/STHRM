...
<script>
import InlineActionButton from '@/sthrmAdminPlugin/components/InlineActionButton.vue';
import {APIService} from '@ohrm/core/util/services/api.service';
import usePaginate from '@ohrm/core/util/composable/usePaginate';
import SavePayCurrency from '@/sthrmAdminPlugin/pages/payGrade/SavePayCurrency.vue';
import EditPayCurrency from '@/sthrmAdminPlugin/pages/payGrade/EditPayCurrency.vue';
