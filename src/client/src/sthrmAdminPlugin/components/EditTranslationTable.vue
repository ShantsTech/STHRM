...
<template>
  <div class="sthrm-translation-container">
    <oxd-divider />
    <oxd-grid :cols="3" class="sthrm-translation-grid">
      <oxd-grid-item class="sthrm-translation-grid-header">
      ...
      <template v-for="(langstring, index) in langstrings" :key="index">
        <oxd-grid-item class="sthrm-translation-grid-text">
          <oxd-text
            class="sthrm-translation-grid-langstring-header"
            type="card-title"
          >
            {{ $t('admin.source_text') }}
          </oxd-text>
        ...
        <oxd-grid-item class="sthrm-translation-grid-text">
          <oxd-text
            class="sthrm-translation-grid-langstring-header-note"
            type="card-title"
          >
            {{ $t('admin.source_note') }}
          </oxd-text>
          <oxd-text
            ...
            class="sthrm-translation-grid-header"
          >
            {{ langstring.note }}
          </oxd-text>
        </oxd-grid-item>
        <oxd-grid-item class="sthrm-translation-grid-text">
          ...
          />
          <oxd-divider class="sthrm-translation-grid-langstring-header" />
        </oxd-grid-item>
      </template>
    </oxd-grid>
    <oxd-divider />
