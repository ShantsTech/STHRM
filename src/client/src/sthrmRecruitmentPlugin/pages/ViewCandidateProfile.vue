...
import RecruitmentStatus from '@/sthrmRecruitmentPlugin/components/RecruitmentStatus';
import CandidateProfile from '@/sthrmRecruitmentPlugin/components/CandidateProfile';
import HistoryTable from '@/sthrmRecruitmentPlugin/components/HistoryTable';
