  ...
  <div class="sthrm-background-container">
    <div class="sthrm-card-container">
      ...
      <oxd-form novalidate="true" :loading="isLoading" @submitValid="onSave">
        ...
        <oxd-grid :cols="3" class="sthrm-full-width-grid">
          <oxd-grid-item class="sthrm-grid-item-span-2">
            <oxd-input-field
        ...
        <oxd-grid :cols="3" class="sthrm-full-width-grid">
          ...
          <oxd-grid-item>
            <oxd-grid :cols="2" class="sthrm-full-width-grid">
              <oxd-grid-item>
                <oxd-input-field
        ...
        <oxd-grid :cols="3" class="sthrm-full-width-grid">
          <oxd-grid-item class="orangerhrm-switch-wrapper">
            <oxd-text class="sthrm-text" tag="p">
              {{ $t('general.active') }}
            </oxd-text>
    ...
    <br />
    <div v-if="isAddClicked && !isEditClicked" class="sthrm-card-container">
      <oxd-text
        tag="h6"
        class="sthrm-main-title sthrm-attachment-header__title"
      >
    ...
    <div v-if="isEditClicked && !isAddClicked" class="sthrm-card-container">
      <oxd-text
        tag="h6"
        class="sthrm-main-title sthrm-attachment-header__title"
      >
    ...
    <div class="sthrm-paper-container">
      <div class="sthrm-header-container sthrm-attachment-header">
        <oxd-text
          tag="h6"
          class="sthrm-main-title sthrm-attachment-header__title"
        >
...
import JobtitleDropdown from '@/sthrmPimPlugin/components/JobtitleDropdown';
