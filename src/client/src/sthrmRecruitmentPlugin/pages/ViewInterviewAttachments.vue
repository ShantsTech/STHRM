...
<template>
  <div class="sthrm-attachment">
    ...
    ></edit-interview-attachment>
    <template v-else>
      <div class="sthrm-attachment-header">
...
import SaveInterviewAttachment from '@/sthrmRecruitmentPlugin/components/SaveInterviewAttachment.vue';
import EditInterviewAttachment from '@/sthrmRecruitmentPlugin/components/EditInterviewAttachment.vue';
