 ...
 */
 -->
<template>
  <div class="sthrm-background-container sthrm-save-candidate-page">
    <div class="sthrm-card-container">
      ...
      <oxd-form :loading="isLoading" @submitValid="onSave">
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="sthrm-full-width-grid">
            <oxd-grid-item class="sthrm-save-candidate-page-full-width">
              <oxd-input-field
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="sthrm-full-width-grid">
            <oxd-grid-item
              class="sthrm-save-candidate-page-full-width sthrm-save-candidate-page-grid-checkbox"
            >
              <oxd-input-field
