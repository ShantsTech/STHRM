...
<template>
  <div class="sthrm-background-container">
    <div class="sthrm-card-container">
      ...
      <oxd-divider />
      <div class="sthrm-information-card-container">
        <oxd-text class="sthrm-sub-title">
          {{ $t('general.note') }}:
        </oxd-text>
        <ul>
          <li>
            <oxd-text class="sthrm-information-card-text">
...
import EmployeeDataImportModal from '@/sthrmPimPlugin/components/EmployeeDataImportModal';
...
.sthrm-information-card-container {
  background-color: $oxd-interface-gray-lighten-2-color;
  border-radius: 1.2rem;
  padding: 1.2rem;
}
.sthrm-information-card-text {
