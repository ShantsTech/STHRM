...
<template>
  ...
  >
    ...
    <div
      ...
      class="sthrm-horizontal-padding sthrm-vertical-padding"
    >
...
import EditEmployeeLayout from '@/sthrmPimPlugin/components/EditEmployeeLayout';
import JobSpecDownload from '@/sthrmPimPlugin/components/JobSpecDownload';
import ProfileActionHeader from '@/sthrmPimPlugin/components/ProfileActionHeader';
import TerminateModal from '@/sthrmPimPlugin/components/TerminateModal';
import {
  required,
  maxFileSize,
  validFileTypes,
