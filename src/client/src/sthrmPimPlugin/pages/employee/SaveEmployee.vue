  ...
  <div class="sthrm-background-container">
    <div class="sthrm-card-container">
      ...
      <oxd-form :loading="isLoading" @submitValid="onSave">
        <div class="sthrm-employee-container">
          <div class="sthrm-employee-image">
            <profile-image-input
...
import ProfileImageInput from '@/sthrmPimPlugin/components/ProfileImageInput';
