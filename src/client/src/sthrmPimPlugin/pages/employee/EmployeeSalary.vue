...
import SaveSalaryComponent from '@/sthrmPimPlugin/components/SaveSalaryComponent';
import EditSalaryComponent from '@/sthrmPimPlugin/components/EditSalaryComponent';
