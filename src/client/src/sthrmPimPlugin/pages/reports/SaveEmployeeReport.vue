  ...
  <div class="sthrm-background-container">
    <div class="sthrm-card-container">
      ...
      <oxd-form :loading="isLoading" @submitValid="onSave">
        ...
        <oxd-divider />
        <oxd-form-row>
          <oxd-text class="sthrm-sub-title" tag="h6">
            {{ $t('pim.selection_criteria') }}
          </oxd-text>
          <oxd-grid :cols="4" class="sthrm-full-width-grid">
            <oxd-grid-item class="sthrm-report-criteria --span-column-2">
              <oxd-input-field
...
import ReportCriterion from '@/sthrmPimPlugin/components/ReportCriterion';
import ReportDisplayField from '@/sthrmPimPlugin/components/ReportDisplayField';
import useEmployeeReport from '@/sthrmPimPlugin/util/composable/useEmployeeReport';
