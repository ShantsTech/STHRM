...
<template>
  <div class="sthrm-horizontal-padding sthrm-top-padding">
    <oxd-text
      v-if="type === 'Supervisor'"
      tag="h6"
      class="sthrm-main-title"
    >
...
<script>
import ReportToEmployeeAutocomplete from '@/sthrmPimPlugin/components/ReportToEmployeeAutocomplete';
