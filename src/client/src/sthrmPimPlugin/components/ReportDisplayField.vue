...
<template>
  <oxd-grid-item class="sthrm-report-field --offset-column-1">
    <oxd-icon-button name="trash-fill" @click="onClickDelete" />
    <oxd-text class="sthrm-report-field-name">
      {{ fieldGroup.label }}
    </oxd-text>
  </oxd-grid-item>
  ...
  <oxd-grid-item class="sthrm-report-field">
    <oxd-text class="sthrm-report-field-header" tag="p">
