...
<template>
  <div class="sthrm-background-container">
    <div class="sthrm-card-container">
      <div class="sthrm-edit-employee">
        <div class="sthrm-edit-employee-navigation">
          <div class="sthrm-edit-employee-imagesection">
            <div class="sthrm-edit-employee-name">
              <oxd-text tag="h6" class="--strong">{{ employeeName }}</oxd-text>
              <oxd-text v-if="!isCurrentEmp" type="subtitle-2">
                {{ $t('general.past_employee') }}
              </oxd-text>
            </div>
            <div class="sthrm-edit-employee-image-wrapper">
              <div
                class="sthrm-edit-employee-image"
        ...
        <div class="sthrm-edit-employee-content">
          <slot></slot>
...
import TabsNavigation from '@/sthrmPimPlugin/components/TabsNavigation';
import ProfileAttachments from '@/sthrmPimPlugin/components/ProfileAttachments';
import ProfileCustomFields from '@/sthrmPimPlugin/components/ProfileCustomFields';
