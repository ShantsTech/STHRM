...
<template>
  <oxd-grid-item class="sthrm-report-criteria --offset-column-1">
    <oxd-icon-button name="trash-fill" @click="onClickDelete" />
    <oxd-text class="sthrm-report-criteria-name">
      {{ criterion.label }}
    </oxd-text>
  </oxd-grid-item>
  <component
...
<script>
import {ref} from 'vue';
import ReportCriterionAutocomplete from '@/sthrmPimPlugin/components/ReportCriterionAutocomplete';
import ReportCriterionSelect from '@/sthrmPimPlugin/components/ReportCriterionSelect';
import ReportCriterionRange from '@/sthrmPimPlugin/components/ReportCriterionRange';
import ReportCriterionDateRange from '@/sthrmPimPlugin/components/ReportCriterionDateRange';
