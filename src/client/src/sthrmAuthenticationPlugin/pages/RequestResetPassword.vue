  ...
  <div class="sthrm-forgot-password-container">
    <div class="sthrm-forgot-password-wrapper">
      <div class="sthrm-card-container">
        ...
        >
          <oxd-text tag="h6" class="sthrm-forgot-password-title">
          ...
          <oxd-divider />
          <div class="sthrm-forgot-password-button-container">
            <oxd-button
              class="sthrm-forgot-password-button sthrm-forgot-password-button--cancel"
              display-type="ghost"
              size="large"
            ...
            />
            <oxd-button
              class="sthrm-forgot-password-button sthrm-forgot-password-button--reset"
