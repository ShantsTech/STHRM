...
<template>
  ...
  >
    <div class="sthrm-attendance-card">
      <div class="sthrm-attendance-card-profile">
        <div class="sthrm-attendance-card-profile-image">
          <img
            alt="profile picture"
        ...
        <div class="sthrm-attendance-card-profile-record">
          <oxd-text tag="p" class="sthrm-attendance-card-state">
            {{ lastState }}
          </oxd-text>
          <oxd-text tag="p" class="sthrm-attendance-card-details">
            {{ lastRecord }}
          </oxd-text>
        </div>
      </div>
      <div class="sthrm-attendance-card-bar">
        <oxd-text tag="span" class="sthrm-attendance-card-fulltime">
        ...
        <oxd-icon-button
          ...
          class="sthrm-attendance-card-action"
          @click="onClickPunchIn"
        />
      </div>
      <oxd-divider />
      <div class="sthrm-attendance-card-summary">
        <div class="sthrm-attendance-card-summary-week">
          <oxd-text tag="p">
        ...
        <div class="sthrm-attendance-card-summary-total">
          <oxd-icon name="stopwatch" class="sthrm-attendance-card-icon" />
          <oxd-text tag="p" class="sthrm-attendance-card-fulltime">
...
import BaseWidget from '@/sthrmDashboardPlugin/components/BaseWidget.vue';
