...
<template>
  ...
  >
    <div v-if="myActions.length > 0" class="sthrm-todo-list">
      <div v-if="leaveRequestCount > 0" class="sthrm-todo-list-item">
        <oxd-icon-button
          class="sthrm-report-icon"
          name="attendanceAlt"
          icon-type="svg"
      ...
      <div v-if="timeSheetCount > 0" class="sthrm-todo-list-item">
        <oxd-icon-button
          class="sthrm-report-icon"
          name="timeAlt"
          icon-type="svg"
      ...
      <div v-if="reviewCount > 0" class="sthrm-todo-list-item">
        <oxd-icon-button
          class="sthrm-report-icon"
          name="appraisals"
          icon-type="svg"
      ...
      <div v-if="selfReviewCount > 0" class="sthrm-todo-list-item">
        <oxd-icon-button
          class="sthrm-report-icon"
          name="appraisals"
          icon-type="svg"
      ...
      <div v-if="interviewCount > 0" class="sthrm-todo-list-item">
        <oxd-icon-button
          class="sthrm-report-icon"
          name="interview"
          icon-type="svg"
