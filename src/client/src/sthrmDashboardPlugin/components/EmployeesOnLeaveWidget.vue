...
<template>
  ...
  >
    ...
    >
      <oxd-icon
        class="sthrm-leave-card-icon"
        name="gear-fill"
        @click="onClickConfig"
      />
    </template>
    <div v-for="leave in leaveList" :key="leave" class="sthrm-leave-card">
      <div class="sthrm-leave-card-profile-image">
        <img
          alt="profile picture"
      ...
      <div class="sthrm-leave-card-details">
        <oxd-text tag="p" class="sthrm-leave-card-emp-name">
          {{ leave.empName }}
        </oxd-text>
        <oxd-text
          v-if="leave.leaveType"
          tag="p"
          class="sthrm-leave-card-leave-details"
        >
          {{ leave.leaveType }}
        </oxd-text>
      </div>
      <oxd-text tag="p" class="sthrm-leave-card-emp-id">
        {{ leave.employeeId }}
      </oxd-text>
    </div>
  </base-widget>
...
import EmployeesOnLeaveConfigModal from '@/sthrmDashboardPlugin/components/EmployeesOnLeaveConfigModal.vue';
