...
<template>
  ...
  >
    <oxd-grid :cols="3" class="sthrm-quick-launch">
      <oxd-grid-item
        v-for="action in sortedActions"
        :key="action"
        class="sthrm-quick-launch-card"
      >
        <oxd-icon-button
          icon-type="svg"
          class="sthrm-quick-launch-icon"
          :name="action.icon"
          :title="action.label"
          @click="onClickAction(action.path)"
        />
        <div class="sthrm-quick-launch-heading" :title="action.label">
