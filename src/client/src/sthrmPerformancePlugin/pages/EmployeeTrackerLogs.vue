...
<template>
  <div class="sthrm-background-container">
    <div class="sthrm-card-container">
      <div class="sthrm-employee-tracker">
        <div class="sthrm-employee-tracker-image-section">
          <div class="sthrm-employee-tracker-image-wrapper">
            <img alt="profile picture" class="employee-image" :src="imgSrc" />
          </div>
        </div>
        <div class="sthrm-employee-tracker-header-section">
          <div class="sthrm-employee-tracker-header">
            <oxd-text tag="h5" class="sthrm-employee-tracker-header-title">
              {{ trackerName }}
            </oxd-text>
            <oxd-text
              tag="h6"
              class="sthrm-employee-tracker-header-subtitle"
            >
              {{ employeeName }}
            </oxd-text>
          </div>
          <div class="sthrm-employee-tracker-ratings">
            <div
              v-if="meta.positive > 0"
              class="sthrm-employee-tracker-ratings-info"
            >
              <oxd-icon
                class="sthrm-employee-tracker-ratings-icon --positive"
                type="svg"
                name="thumbsup"
              />
              <oxd-text
                class="sthrm-employee-tracker-ratings-text --positive"
              >
                {{ meta.positive }}
              </oxd-text>
            </div>
            ...
            >
              <oxd-icon
                class="sthrm-employee-tracker-ratings-icon --negative"
                type="svg"
                name="thumbsdown"
              />
              <oxd-text
                class="sthrm-employee-tracker-ratings-text --negative"
              >
                {{ meta.negative }}
              </oxd-text>
            </div>
    ...
    <div class="sthrm-paper-container">
      <div class="sthrm-header-container">
        <oxd-text tag="h5" class="sthrm-employee-tracker-list-header">
      ...
      <div ref="scrollerRef" class="sthrm-container">
        <oxd-sheet
          v-for="(item, index) in items"
          :key="index"
          :gutters="false"
          type="gray-lighten-2"
          class="sthrm-scroll-card"
        >
        ...
        <div
          ...
          class="sthrm-employee-tracker-no-records"
        >
          <oxd-text>
...
import AddTrackerLogModal from '@/sthrmPerformancePlugin/components/AddTrackerLogModal';
import EditTrackerLogModal from '@/sthrmPerformancePlugin/components/EditTrackerLogModal';
import DeleteConfirmationDialog from '@/core/components/dialogs/DeleteConfirmationDialog';
import EmployeeTrackerLogCard from '@/sthrmPerformancePlugin/components/EmployeeTrackerLogCard';
