...
<template>
  <div class="sthrm-evaluation sthrm-card-container">
    <oxd-text class="sthrm-main-title">
      {{ title }}
    </oxd-text>

    <div class="sthrm-evaluation-header">
      <oxd-grid :cols="3" class="sthrm-evaluation-header-grid">
        <oxd-grid-item class="sthrm-evaluation-title">
          <img
            class="sthrm-evaluation-title-profile-image"
            alt="profile picture"
            :src="profileImgSrc"
          />
          <div class="sthrm-evaluation-title-name">
    ...
    <template v-if="!isCollapsed">
      <oxd-divider />
      <oxd-grid :cols="4" class="sthrm-evaluation-grid">
        <oxd-grid-item class="sthrm-evaluation-grid-header">
        ...
        <oxd-grid-item
          class="sthrm-evaluation-grid-spacer-md"
        ></oxd-grid-item>

        <template v-for="(kpi, index) in kpis" :key="kpi.id">
          <oxd-grid-item class="sthrm-evaluation-grid-kpi">
            <oxd-text
              class="sthrm-evaluation-grid-kpi-header"
              type="subtitle-2"
            >
              {{ $t('performance.kpi') }}
            </oxd-text>
            <oxd-text
              :title="kpi.title"
              tag="p"
              class="sthrm-evaluation-grid-kpi-label"
            >
              {{ kpi.title }}
            </oxd-text>
            <oxd-text class="sthrm-evaluation-grid-kpi-minmax" tag="p">
          ...
          <oxd-grid-item>
            ...
            <oxd-input-field
              class="sthrm-evaluation-grid-comment"
              rows="2"
              type="textarea"
              :disabled="!editable"
      ...
      <oxd-divider />
      <oxd-grid :cols="3" class="sthrm-evaluation-grid">
        <oxd-grid-item class="sthrm-evaluation-grid-general">
          <oxd-text tag="p" class="sthrm-evaluation-grid-general-label">
