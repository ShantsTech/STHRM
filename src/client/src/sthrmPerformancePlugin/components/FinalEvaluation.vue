...
<template>
  <div>
    <oxd-text class="sthrm-performance-review-title">
      {{ $t('performance.review_finalization') }}
    </oxd-text>
    <br />
    <oxd-grid :cols="4" class="sthrm-performance-review-grid">
      <oxd-grid-item>
        ...
        />
        <div v-else class="sthrm-performance-review-read">
          <oxd-text>{{ formattedCompletedDate }}</oxd-text>
        </div>
      </oxd-grid-item>
      <oxd-grid-item class="sthrm-performance-review-grid-rating">
        <oxd-text type="subtitle-2">
