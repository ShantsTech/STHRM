        ...
        <oxd-grid :cols="2" class="sthrm-full-width-grid">
          ...
          <oxd-grid-item>
            ...
            <oxd-button
              ...
              icon-name="plus"
              display-type="text"
              class="sthrm-input-field-bottom-space"
...
import Activities from '@/sthrmTimePlugin/components/Activities.vue';
import AddCustomerModal from '@/sthrmTimePlugin/components/AddCustomerModal.vue';
import CustomerAutocomplete from '@/sthrmTimePlugin/components/CustomerAutocomplete.vue';
import ProjectAdminAutocomplete from '@/sthrmTimePlugin/components/ProjectAdminAutocomplete.vue';
