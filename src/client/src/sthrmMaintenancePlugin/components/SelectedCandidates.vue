...
<template>
  ...
  <div v-if="vacancy" class="sthrm-paper-container">
    <div v-show="total > 0" class="sthrm-header-container">
      <oxd-button
...
import CandidateRecords from '@/sthrmMaintenancePlugin/components/CandidateRecords';
