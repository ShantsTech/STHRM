    ...
    <oxd-form @submit="emitVerify">
      ...
      <oxd-form-row>
        <oxd-grid :cols="1" class="sthrm-full-width-grid">
          <oxd-grid-item>
            <div class="sthrm-maintenance-note">
              <div class="sthrm-maintenance-note-header">
...
export default {
  ...
  data() {
    return {
      ...
      noteText:
        'Users who seek access to their data, or who seek to correct, amend, or delete the given information should direct their requests to Data@shants-tech.com with the subject "Purge Records (Instance Identifier : T0hSTV9kZXZpQHRlc3QuY29tX0RldmlfRFNfcGhwNzNfXzQuOV8xNjQ2MDE1NzQw REPLACE WITH REAL INSTANCE IDENTIFIER)"',
      password: '',
      rules: {
        password: [required],
      },
