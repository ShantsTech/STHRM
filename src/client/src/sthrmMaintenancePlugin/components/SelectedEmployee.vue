...
<template>
  <div class="sthrm-card-container">
    ...
    <oxd-form :loading="loading" @submit="emitEmpNumber">
      <div class="sthrm-selected-employee">
        <div class="sthrm-selected-employee-imagesection">
          <div class="sthrm-selected-employee-image-wrapper">
            <div class="sthrm-selected-employee-image">
              <img alt="profile picture" class="employee-image" :src="imgSrc" />
            </div>
          </div>
        </div>
        <div class="sthrm-selected-employee-content">
          <oxd-form-row>
