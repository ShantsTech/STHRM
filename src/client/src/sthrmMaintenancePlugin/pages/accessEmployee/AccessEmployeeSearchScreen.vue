...
<template>
  <employee-records
    ...
    @search="search"
  ></employee-records>
  <div v-if="employee" class="sthrm-background-container">
    <selected-employee
...
<script>
import EmployeeRecords from '@/sthrmMaintenancePlugin/components/EmployeeRecords';
import SelectedEmployee from '@/sthrmMaintenancePlugin/components/SelectedEmployee';
import MaintenanceNote from '@/sthrmMaintenancePlugin/components/MaintenanceNote';
