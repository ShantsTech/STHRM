 ...
 */
class Report extends \ShantsHRM\Entity\Report implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\Report' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\Report' . "\0" . 'name', '' . "\0" . 'ShantsHRM\\Entity\\Report' . "\0" . 'reportGroup', '' . "\0" . 'ShantsHRM\\Entity\\Report' . "\0" . 'useFilterField', '' . "\0" . 'ShantsHRM\\Entity\\Report' . "\0" . 'type'];
        }
