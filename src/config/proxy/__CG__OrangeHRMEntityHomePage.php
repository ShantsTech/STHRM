 ...
 */
class HomePage extends \ShantsHRM\Entity\HomePage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\HomePage' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\HomePage' . "\0" . 'action', '' . "\0" . 'ShantsHRM\\Entity\\HomePage' . "\0" . 'enableClass', '' . "\0" . 'ShantsHRM\\Entity\\HomePage' . "\0" . 'priority', '' . "\0" . 'ShantsHRM\\Entity\\HomePage' . "\0" . 'userRole'];
        }
