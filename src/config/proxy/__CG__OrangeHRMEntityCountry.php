 ...
 */
class Country extends \ShantsHRM\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\Country' . "\0" . 'countryCode', '' . "\0" . 'ShantsHRM\\Entity\\Country' . "\0" . 'name', '' . "\0" . 'ShantsHRM\\Entity\\Country' . "\0" . 'countryName', '' . "\0" . 'ShantsHRM\\Entity\\Country' . "\0" . 'iso3', '' . "\0" . 'ShantsHRM\\Entity\\Country' . "\0" . 'numCode'];
        }
