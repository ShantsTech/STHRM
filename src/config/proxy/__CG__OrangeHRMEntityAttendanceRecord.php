 ...
 */
class AttendanceRecord extends \ShantsHRM\Entity\AttendanceRecord implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchInUtcTime', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchInNote', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchInTimeOffset', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchInTimezoneName', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchInUserTime', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchOutUtcTime', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchOutNote', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchOutTimeOffset', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchOutTimezoneName', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'punchOutUserTime', '' . "\0" . 'ShantsHRM\\Entity\\AttendanceRecord' . "\0" . 'state', 'entityDecorator'];
        }
