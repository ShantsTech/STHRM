 ...
 */
class EmployeeEvent extends \ShantsHRM\Entity\EmployeeEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeEvent' . "\0" . 'eventId', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeEvent' . "\0" . 'empNumber', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeEvent' . "\0" . 'type', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeEvent' . "\0" . 'event', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeEvent' . "\0" . 'note', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeEvent' . "\0" . 'createdDate', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeEvent' . "\0" . 'createdBy'];
        }
