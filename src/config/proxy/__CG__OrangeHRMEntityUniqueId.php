 ...
 */
class UniqueId extends \ShantsHRM\Entity\UniqueId implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\UniqueId' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\UniqueId' . "\0" . 'lastId', '' . "\0" . 'ShantsHRM\\Entity\\UniqueId' . "\0" . 'tableName', '' . "\0" . 'ShantsHRM\\Entity\\UniqueId' . "\0" . 'fieldName'];
        }
