 ...
 */
class VacancyAttachment extends \ShantsHRM\Entity\VacancyAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\VacancyAttachment' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\VacancyAttachment' . "\0" . 'vacancy', '' . "\0" . 'ShantsHRM\\Entity\\VacancyAttachment' . "\0" . 'fileName', '' . "\0" . 'ShantsHRM\\Entity\\VacancyAttachment' . "\0" . 'fileType', '' . "\0" . 'ShantsHRM\\Entity\\VacancyAttachment' . "\0" . 'fileSize', '' . "\0" . 'ShantsHRM\\Entity\\VacancyAttachment' . "\0" . 'fileContent', '' . "\0" . 'ShantsHRM\\Entity\\VacancyAttachment' . "\0" . 'attachmentType', '' . "\0" . 'ShantsHRM\\Entity\\VacancyAttachment' . "\0" . 'comment', 'entityDecorator'];
        }
