 ...
 */
class EmpEmergencyContact extends \ShantsHRM\Entity\EmpEmergencyContact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmpEmergencyContact' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\EmpEmergencyContact' . "\0" . 'seqNo', '' . "\0" . 'ShantsHRM\\Entity\\EmpEmergencyContact' . "\0" . 'name', '' . "\0" . 'ShantsHRM\\Entity\\EmpEmergencyContact' . "\0" . 'relationship', '' . "\0" . 'ShantsHRM\\Entity\\EmpEmergencyContact' . "\0" . 'homePhone', '' . "\0" . 'ShantsHRM\\Entity\\EmpEmergencyContact' . "\0" . 'mobilePhone', '' . "\0" . 'ShantsHRM\\Entity\\EmpEmergencyContact' . "\0" . 'officePhone', 'entityDecorator'];
        }
