 ...
 */
class EmployeeAttachment extends \ShantsHRM\Entity\EmployeeAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'attachId', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'description', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'filename', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'size', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'attachment', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'fileType', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'screen', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'attachedBy', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'attachedByName', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeAttachment' . "\0" . 'attachedTime', 'entityDecorator'];
        }
