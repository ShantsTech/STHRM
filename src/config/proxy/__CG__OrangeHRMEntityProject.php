 ...
 */
class Project extends \ShantsHRM\Entity\Project implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\Project' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\Project' . "\0" . 'customer', '' . "\0" . 'ShantsHRM\\Entity\\Project' . "\0" . 'name', '' . "\0" . 'ShantsHRM\\Entity\\Project' . "\0" . 'description', '' . "\0" . 'ShantsHRM\\Entity\\Project' . "\0" . 'deleted', '' . "\0" . 'ShantsHRM\\Entity\\Project' . "\0" . 'projectAdmins', 'entityDecorator'];
        }
     ...
     * {@inheritDoc}
     */
    public function getCustomer(): \ShantsHRM\Entity\Customer
    {
     ...
     * {@inheritDoc}
     */
    public function setCustomer(\ShantsHRM\Entity\Customer $customer): void
    {
