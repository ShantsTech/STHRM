 ...
 */
class RegistrationEventQueue extends \ShantsHRM\Entity\RegistrationEventQueue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\RegistrationEventQueue' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\RegistrationEventQueue' . "\0" . 'eventType', '' . "\0" . 'ShantsHRM\\Entity\\RegistrationEventQueue' . "\0" . 'published', '' . "\0" . 'ShantsHRM\\Entity\\RegistrationEventQueue' . "\0" . 'eventTime', '' . "\0" . 'ShantsHRM\\Entity\\RegistrationEventQueue' . "\0" . 'publishTime', '' . "\0" . 'ShantsHRM\\Entity\\RegistrationEventQueue' . "\0" . 'data'];
        }
