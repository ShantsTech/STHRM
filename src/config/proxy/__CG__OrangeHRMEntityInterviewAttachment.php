 ...
 */
class InterviewAttachment extends \ShantsHRM\Entity\InterviewAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\InterviewAttachment' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\InterviewAttachment' . "\0" . 'interview', '' . "\0" . 'ShantsHRM\\Entity\\InterviewAttachment' . "\0" . 'fileName', '' . "\0" . 'ShantsHRM\\Entity\\InterviewAttachment' . "\0" . 'fileType', '' . "\0" . 'ShantsHRM\\Entity\\InterviewAttachment' . "\0" . 'fileSize', '' . "\0" . 'ShantsHRM\\Entity\\InterviewAttachment' . "\0" . 'fileContent', '' . "\0" . 'ShantsHRM\\Entity\\InterviewAttachment' . "\0" . 'attachmentType', '' . "\0" . 'ShantsHRM\\Entity\\InterviewAttachment' . "\0" . 'comment', 'entityDecorator'];
        }
