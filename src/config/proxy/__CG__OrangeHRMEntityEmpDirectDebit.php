 ...
 */
class EmpDirectDebit extends \ShantsHRM\Entity\EmpDirectDebit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmpDirectDebit' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\EmpDirectDebit' . "\0" . 'salary', '' . "\0" . 'ShantsHRM\\Entity\\EmpDirectDebit' . "\0" . 'routingNumber', '' . "\0" . 'ShantsHRM\\Entity\\EmpDirectDebit' . "\0" . 'account', '' . "\0" . 'ShantsHRM\\Entity\\EmpDirectDebit' . "\0" . 'amount', '' . "\0" . 'ShantsHRM\\Entity\\EmpDirectDebit' . "\0" . 'accountType', '' . "\0" . 'ShantsHRM\\Entity\\EmpDirectDebit' . "\0" . 'transactionType'];
        }
     ...
     * {@inheritDoc}
     */
    public function getSalary(): \ShantsHRM\Entity\EmployeeSalary
    {
     ...
     * {@inheritDoc}
     */
    public function setSalary(\ShantsHRM\Entity\EmployeeSalary $salary): void
    {
