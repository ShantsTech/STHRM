 ...
 */
class I18NTranslation extends \ShantsHRM\Entity\I18NTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\I18NTranslation' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\I18NTranslation' . "\0" . 'langString', '' . "\0" . 'ShantsHRM\\Entity\\I18NTranslation' . "\0" . 'language', '' . "\0" . 'ShantsHRM\\Entity\\I18NTranslation' . "\0" . 'value', '' . "\0" . 'ShantsHRM\\Entity\\I18NTranslation' . "\0" . 'customized', '' . "\0" . 'ShantsHRM\\Entity\\I18NTranslation' . "\0" . 'modifiedAt', 'entityDecorator'];
        }
     ...
     * {@inheritDoc}
     */
    public function getLangString(): \ShantsHRM\Entity\I18NLangString
    {
     ...
     * {@inheritDoc}
     */
    public function setLangString(\ShantsHRM\Entity\I18NLangString $langString): void
    {
     ...
     * {@inheritDoc}
     */
    public function getLanguage(): \ShantsHRM\Entity\I18NLanguage
    {
     ...
     * {@inheritDoc}
     */
    public function setLanguage(\ShantsHRM\Entity\I18NLanguage $language): void
    {
