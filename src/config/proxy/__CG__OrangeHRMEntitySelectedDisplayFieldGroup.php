 ...
 */
class SelectedDisplayFieldGroup extends \ShantsHRM\Entity\SelectedDisplayFieldGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\SelectedDisplayFieldGroup' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\SelectedDisplayFieldGroup' . "\0" . 'report', '' . "\0" . 'ShantsHRM\\Entity\\SelectedDisplayFieldGroup' . "\0" . 'displayFieldGroup', 'entityDecorator'];
        }
