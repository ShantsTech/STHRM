 ...
 */
class EmpPicture extends \ShantsHRM\Entity\EmpPicture implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmpPicture' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\EmpPicture' . "\0" . 'picture', '' . "\0" . 'ShantsHRM\\Entity\\EmpPicture' . "\0" . 'filename', '' . "\0" . 'ShantsHRM\\Entity\\EmpPicture' . "\0" . 'fileType', '' . "\0" . 'ShantsHRM\\Entity\\EmpPicture' . "\0" . 'size', '' . "\0" . 'ShantsHRM\\Entity\\EmpPicture' . "\0" . 'width', '' . "\0" . 'ShantsHRM\\Entity\\EmpPicture' . "\0" . 'height', 'entityDecorator'];
        }
