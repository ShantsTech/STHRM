 ...
 */
class UserAuthProvider extends \ShantsHRM\Entity\UserAuthProvider implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\UserAuthProvider' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\UserAuthProvider' . "\0" . 'user', '' . "\0" . 'ShantsHRM\\Entity\\UserAuthProvider' . "\0" . 'type', '' . "\0" . 'ShantsHRM\\Entity\\UserAuthProvider' . "\0" . 'ldapUserHash', '' . "\0" . 'ShantsHRM\\Entity\\UserAuthProvider' . "\0" . 'ldapUserDN', '' . "\0" . 'ShantsHRM\\Entity\\UserAuthProvider' . "\0" . 'ldapUserUniqueId'];
        }
