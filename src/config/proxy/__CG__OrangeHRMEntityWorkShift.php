 ...
 */
class WorkShift extends \ShantsHRM\Entity\WorkShift implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\WorkShift' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\WorkShift' . "\0" . 'name', '' . "\0" . 'ShantsHRM\\Entity\\WorkShift' . "\0" . 'hoursPerDay', '' . "\0" . 'ShantsHRM\\Entity\\WorkShift' . "\0" . 'startTime', '' . "\0" . 'ShantsHRM\\Entity\\WorkShift' . "\0" . 'endTime', 'entityDecorator'];
        }
