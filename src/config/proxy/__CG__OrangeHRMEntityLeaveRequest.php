 ...
 */
class LeaveRequest extends \ShantsHRM\Entity\LeaveRequest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\LeaveRequest' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\LeaveRequest' . "\0" . 'leaveType', '' . "\0" . 'ShantsHRM\\Entity\\LeaveRequest' . "\0" . 'dateApplied', '' . "\0" . 'ShantsHRM\\Entity\\LeaveRequest' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\LeaveRequest' . "\0" . 'leaves', 'entityDecorator'];
        }
