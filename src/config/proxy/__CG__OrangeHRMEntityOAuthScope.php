 ...
 */
class OAuthScope extends \ShantsHRM\Entity\OAuthScope implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\OAuthScope' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\OAuthScope' . "\0" . 'scope', '' . "\0" . 'ShantsHRM\\Entity\\OAuthScope' . "\0" . 'isDefault'];
        }
