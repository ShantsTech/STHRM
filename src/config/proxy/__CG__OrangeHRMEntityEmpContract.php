 ...
 */
class EmpContract extends \ShantsHRM\Entity\EmpContract implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmpContract' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\EmpContract' . "\0" . 'contractId', '' . "\0" . 'ShantsHRM\\Entity\\EmpContract' . "\0" . 'startDate', '' . "\0" . 'ShantsHRM\\Entity\\EmpContract' . "\0" . 'endDate', 'entityDecorator'];
        }
