 ...
 */
class User extends \ShantsHRM\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'userName', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'userPassword', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'deleted', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'status', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'dateEntered', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'dateModified', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'modifiedUserId', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'createdBy', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'userRole', '' . "\0" . 'ShantsHRM\\Entity\\User' . "\0" . 'authProviders', 'entityDecorator'];
        }
