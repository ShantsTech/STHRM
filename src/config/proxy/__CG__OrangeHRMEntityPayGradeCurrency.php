 ...
 */
class PayGradeCurrency extends \ShantsHRM\Entity\PayGradeCurrency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\PayGradeCurrency' . "\0" . 'payGrade', '' . "\0" . 'ShantsHRM\\Entity\\PayGradeCurrency' . "\0" . 'currencyType', '' . "\0" . 'ShantsHRM\\Entity\\PayGradeCurrency' . "\0" . 'minSalary', '' . "\0" . 'ShantsHRM\\Entity\\PayGradeCurrency' . "\0" . 'maxSalary', '' . "\0" . 'ShantsHRM\\Entity\\PayGradeCurrency' . "\0" . 'payGradeId', '' . "\0" . 'ShantsHRM\\Entity\\PayGradeCurrency' . "\0" . 'currencyId'];
        }
