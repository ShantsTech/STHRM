 ...
 */
class Config extends \ShantsHRM\Entity\Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\Config' . "\0" . 'name', '' . "\0" . 'ShantsHRM\\Entity\\Config' . "\0" . 'value'];
        }
