 ...
 */
class Province extends \ShantsHRM\Entity\Province implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\Province' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\Province' . "\0" . 'provinceName', '' . "\0" . 'ShantsHRM\\Entity\\Province' . "\0" . 'provinceCode', '' . "\0" . 'ShantsHRM\\Entity\\Province' . "\0" . 'countryCode'];
        }
