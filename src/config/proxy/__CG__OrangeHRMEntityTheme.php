 ...
 */
class Theme extends \ShantsHRM\Entity\Theme implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'name', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'variables', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'clientLogo', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'clientLogoFilename', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'clientLogoFileType', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'clientLogoFileSize', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'clientBanner', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'clientBannerFilename', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'clientBannerFileType', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'clientBannerFileSize', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'loginBanner', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'loginBannerFilename', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'loginBannerFileType', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'loginBannerFileSize', '' . "\0" . 'ShantsHRM\\Entity\\Theme' . "\0" . 'showSocialMediaIcons'];
        }
