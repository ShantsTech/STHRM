 ...
 */
class EmployeeSkill extends \ShantsHRM\Entity\EmployeeSkill implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeSkill' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeSkill' . "\0" . 'skill', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeSkill' . "\0" . 'yearsOfExp', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeSkill' . "\0" . 'comments', 'entityDecorator'];
        }
     ...
     * {@inheritDoc}
     */
    public function getSkill(): ?\ShantsHRM\Entity\Skill
    {
     ...
     * {@inheritDoc}
     */
    public function setSkill(\ShantsHRM\Entity\Skill $skill): void
    {
