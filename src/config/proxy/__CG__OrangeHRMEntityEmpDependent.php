 ...
 */
class EmpDependent extends \ShantsHRM\Entity\EmpDependent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmpDependent' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\EmpDependent' . "\0" . 'seqNo', '' . "\0" . 'ShantsHRM\\Entity\\EmpDependent' . "\0" . 'name', '' . "\0" . 'ShantsHRM\\Entity\\EmpDependent' . "\0" . 'relationshipType', '' . "\0" . 'ShantsHRM\\Entity\\EmpDependent' . "\0" . 'relationship', '' . "\0" . 'ShantsHRM\\Entity\\EmpDependent' . "\0" . 'dateOfBirth', 'entityDecorator'];
        }
