 ...
 */
class EmailTemplate extends \ShantsHRM\Entity\EmailTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmailTemplate' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\EmailTemplate' . "\0" . 'email', '' . "\0" . 'ShantsHRM\\Entity\\EmailTemplate' . "\0" . 'locale', '' . "\0" . 'ShantsHRM\\Entity\\EmailTemplate' . "\0" . 'performerRole', '' . "\0" . 'ShantsHRM\\Entity\\EmailTemplate' . "\0" . 'recipientRole', '' . "\0" . 'ShantsHRM\\Entity\\EmailTemplate' . "\0" . 'subject', '' . "\0" . 'ShantsHRM\\Entity\\EmailTemplate' . "\0" . 'body'];
        }
     ...
     * {@inheritDoc}
     */
    public function getEmail(): \ShantsHRM\Entity\Email
    {
     ...
     * {@inheritDoc}
     */
    public function setEmail(\ShantsHRM\Entity\Email $email): void
    {
