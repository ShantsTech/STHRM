 ...
 */
class EmployeeImmigrationRecord extends \ShantsHRM\Entity\EmployeeImmigrationRecord implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'employee', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'recordId', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'number', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'issuedDate', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'expiryDate', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'comment', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'type', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'status', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'reviewDate', '' . "\0" . 'ShantsHRM\\Entity\\EmployeeImmigrationRecord' . "\0" . 'countryCode', 'entityDecorator'];
        }
