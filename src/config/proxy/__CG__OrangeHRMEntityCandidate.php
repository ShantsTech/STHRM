 ...
 */
class Candidate extends \ShantsHRM\Entity\Candidate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'id', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'firstName', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'middleName', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'lastName', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'email', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'contactNumber', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'status', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'comment', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'modeOfApplication', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'dateOfApplication', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'cvFileId', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'cvTextVersion', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'keywords', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'addedPerson', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'consentToKeepData', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'candidateVacancy', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'candidateAttachment', '' . "\0" . 'ShantsHRM\\Entity\\Candidate' . "\0" . 'candidateHistory', 'entityDecorator'];
        }
     ...
     * {@inheritDoc}
     */
    public function getAddedPerson(): ?\ShantsHRM\Entity\Employee
    {
     ...
     * {@inheritDoc}
     */
    public function setAddedPerson(?\ShantsHRM\Entity\Employee $addedPerson): void
    {
