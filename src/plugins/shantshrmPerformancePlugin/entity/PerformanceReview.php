...
use ShantsHRM\Entity\Decorator\PerformanceReviewDecorator;
...
class PerformanceReview
{
     ...
     * @var ReviewerRating[]
     *
     * @ORM\ManyToMany(targetEntity="ShantsHRM\Entity\ReviewerRating", mappedBy="PerformanceReview")
     * @ORM\JoinColumns({
     ...
     * @var Reviewer[]
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\Reviewer", mappedBy="review")
     */
     ...
     * @var JobTitle|null
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\JobTitle", inversedBy="PerformanceReview")
     * @ORM\JoinColumns({
     ...
     * @var Subunit|null
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Subunit", inversedBy="PerformanceReview")
     * @ORM\JoinColumns({
     ...
     * @var Employee|null
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="PerformanceReview")
     * @ORM\JoinColumns({
