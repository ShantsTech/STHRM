...
use ShantsHRM\Entity\Decorator\PerformanceTrackerDecorator;
...
class PerformanceTracker
{
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\PerformanceTrackerReviewer", mappedBy="performanceTracker")
     */
