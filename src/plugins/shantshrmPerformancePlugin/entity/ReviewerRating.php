...
use ShantsHRM\Entity\Decorator\ReviewerRatingDecorator;
...
class ReviewerRating
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\PerformanceReview", inversedBy="ReviewerRating")
     * @ORM\JoinColumns({
     ...
     * @var Reviewer
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Reviewer", inversedBy="ReviewerRating")
     * @ORM\JoinColumns({
     ...
     * @var Kpi|null
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Kpi", inversedBy="ReviewerRating")
     * @ORM\JoinColumns({
