...
use ShantsHRM\Entity\Decorator\ReviewerDecorator;
...
class Reviewer
{
     ...
     * @var ReviewerRating[]
     *
     * @ORM\ManyToMany(targetEntity="ShantsHRM\Entity\ReviewerRating", mappedBy="Reviewer")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\ReviewerGroup", inversedBy="Reviewer")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\PerformanceReview", inversedBy="Reviewer")
     * @ORM\JoinColumns({
     ...
     * @var Employee|null
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="Reviewer")
     * @ORM\JoinColumns({
