...
use ShantsHRM\Admin\Api\Model\JobTitleModel;
use ShantsHRM\Admin\Dto\JobTitleSearchFilterParams;
...
use ShantsHRM\Core\Api\V2\Validator\Rules\EntityUniquePropertyOption;
...
class JobTitleAPI extends Endpoint implements CrudEndpoint
{
     ...
     *             @OA\Property(property="description", type="string", default=null),
     *             @OA\Property(property="note", type="string", default=null),
     *             @OA\Property(property="currentJobSpecification", type="string", enum=ShantsHRM\Admin\Api\JobTitleAPI::CURRENT_JOB_SPECIFICATION, default=null),
     *             @OA\Property(property="specification", ref="#/components/schemas/Base64AttachmentOrNull"),
     *             required={"title"}
     *         )
     *     ),
