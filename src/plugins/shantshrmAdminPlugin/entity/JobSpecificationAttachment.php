...
use ShantsHRM\Entity\Decorator\JobSpecificationAttachmentDecorator;
...
class JobSpecificationAttachment
{
     ...
     * @var JobTitle
     *
     * @ORM\OneToOne(targetEntity="ShantsHRM\Entity\JobTitle", inversedBy="jobSpecificationAttachment", cascade={"persist", "remove"})
