...
use ShantsHRM\Entity\Decorator\LocationDecorator;
...
class Location
{
     ...
     * @var Country
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Country")
     ...
     * @var Employee[]
     *
     * @ORM\ManyToMany(targetEntity="ShantsHRM\Entity\Employee", mappedBy="locations")
     */
