...
class JobTitle
{
     ...
     *
     * @ORM\OneToOne(targetEntity="ShantsHRM\Entity\JobSpecificationAttachment", mappedBy="jobTitle", cascade={"persist", "remove"})
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\Employee", mappedBy="jobTitle")
     */
    private $employees;
