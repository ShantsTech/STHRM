...
use ShantsHRM\Entity\Decorator\AttendanceRecordDecorator;
...
class AttendanceRecord
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="attendanceRecords", cascade={"persist", "remove"})
