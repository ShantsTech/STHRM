...
use ShantsHRM\Entity\Decorator\CandidateHistoryDecorator;
...
class CandidateHistory
{
    ...
    /**
     * @var Candidate
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Candidate", cascade={"persist", "remove"})
    ...
    /**
     * @var Vacancy|null
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Vacancy", cascade={"persist", "remove"})
     ...
     * @var Interview|null
     *
     * @ORM\OneToOne(targetEntity="ShantsHRM\Entity\Interview", cascade={"persist", "remove"})
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="candidates", cascade={"persist", "remove"})
