...
use ShantsHRM\Entity\Decorator\CandidateDecorator;
...
class Candidate
{
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="candidates", cascade={"persist"})
     ...
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\CandidateVacancy", mappedBy="candidate")
     */
    private iterable $candidateVacancy;

    /**
     * @var iterable|CandidateAttachment[]
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\CandidateAttachment", mappedBy="candidate")
     */
    private iterable $candidateAttachment;

    /**
     * @var iterable|CandidateHistory[]
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\CandidateHistory", mappedBy="candidate")
     */
