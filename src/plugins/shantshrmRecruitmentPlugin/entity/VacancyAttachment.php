...
use ShantsHRM\Entity\Decorator\VacancyAttachmentDecorator;
...
class VacancyAttachment
{
    ...
    /**
     * @var Vacancy
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Vacancy", inversedBy="vacancies", cascade={"persist", "remove"})
