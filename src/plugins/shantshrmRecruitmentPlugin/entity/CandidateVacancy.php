...
use DateTime;
use ShantsHRM\Entity\Decorator\CandidateVacancyDecorator;
...
class CandidateVacancy
{
    ...
    /**
     * @var Candidate
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Candidate", inversedBy="candidateVacancy", cascade={"persist", "remove"})
