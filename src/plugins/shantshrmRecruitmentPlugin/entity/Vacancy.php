...
use ShantsHRM\Entity\Decorator\VacancyDecorator;
...
class Vacancy
{
    ...
    /**
     * @var JobTitle
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\JobTitle", inversedBy="vacancies", cascade={"persist", "remove"})
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="vacancies", cascade={"persist", "remove"})
