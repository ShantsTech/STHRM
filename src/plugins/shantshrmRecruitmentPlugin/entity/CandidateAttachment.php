...
use ShantsHRM\Entity\Decorator\CandidateAttachmentDecorator;
...
class CandidateAttachment
{
    ...
    /**
     * @var Candidate
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Candidate", inversedBy="candidateAttachments", cascade={"persist", "remove"})
