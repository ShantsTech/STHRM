...
use ShantsHRM\Entity\Decorator\InterviewDecorator;
...
class Interview
{
     ...
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\CandidateVacancy", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="ShantsHRM\Entity\Employee")
