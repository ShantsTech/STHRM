...
use ShantsHRM\Entity\Decorator\I18NTranslationDecorator;
...
class I18NTranslation
{
     ...
     * @var I18NLangString
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\I18NLangString", inversedBy="translations")
     ...
     * @var I18NLanguage
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\I18NLanguage")
