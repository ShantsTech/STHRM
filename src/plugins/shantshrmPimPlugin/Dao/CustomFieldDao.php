...
use ShantsHRM\Entity\CustomField;
...
use ShantsHRM\Pim\Dto\CustomFieldSearchFilterParams;
...
class CustomFieldDao extends BaseDao
{
    ...
    private function addCustomFieldToDisplayField(CustomField $customField): void
    {
        ...
        if (!$displayField instanceof DisplayField) {
            ...
            $displayField->setClassName('ShantsHRM\Core\Report\DisplayField\GenericBasicDisplayField');
        }
