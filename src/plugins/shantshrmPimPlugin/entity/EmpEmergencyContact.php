...
use ShantsHRM\Entity\Decorator\EmpEmergencyContactDecorator;
...
class EmpEmergencyContact
{
     ...
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="emergencyContacts", cascade={"persist"})
