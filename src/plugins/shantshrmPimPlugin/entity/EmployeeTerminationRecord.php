...
use ShantsHRM\Entity\Decorator\EmployeeTerminationRecordDecorator;
...
class EmployeeTerminationRecord
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\TerminationReason")
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="employeeTerminationRecords")
