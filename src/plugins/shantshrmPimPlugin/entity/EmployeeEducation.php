...
use ShantsHRM\Entity\Decorator\EmployeeEducationDecorator;
...
class EmployeeEducation
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="educations", cascade={"persist"})
     ...
     * @var Education
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Education", inversedBy="employeeEducation")
