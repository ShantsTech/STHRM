...
use ShantsHRM\Entity\Decorator\EmployeeLanguageDecorator;
...
class EmployeeLanguage
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="languages", cascade={"persist"})
     * @ORM\Id
     ...
     * @var Language
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Language", inversedBy="employeeLanguages")
     * @ORM\Id
