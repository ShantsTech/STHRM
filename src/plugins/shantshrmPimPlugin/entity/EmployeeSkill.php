...
use ShantsHRM\Entity\Decorator\EmployeeSkillDecorator;
...
class EmployeeSkill
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="skills", cascade={"persist"})
     * @ORM\Id
     ...
     * @var Skill
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Skill", inversedBy="employeeSkills")
     * @ORM\Id
