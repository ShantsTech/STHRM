...
use ShantsHRM\Entity\Decorator\EmployeeLicenseDecorator;
...
class EmployeeLicense
{
     ...
     * @var License
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\License", inversedBy="employeeLicenses")
     * @ORM\Id
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="licenses", cascade={"persist"})
     * @ORM\Id
