...
use ShantsHRM\Entity\Decorator\EmpWorkExperienceDecorator;
...
class EmpWorkExperience
{
     ...
     * @var Employee
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="workExperience", cascade={"persist"})
