...
use ShantsHRM\Entity\Decorator\EmployeeSalaryDecorator;
 ...
 * @ORM\Entity
 * @ORM\EntityListeners({"ShantsHRM\Entity\Listener\EmployeeSalaryListener"})
 */
class EmployeeSalary
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="salaries", cascade={"persist"})
     ...
     * @var PayGrade|null
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\PayGrade")
     ...
     * @var CurrencyType
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\CurrencyType")
     ...
     * @var PayPeriod|null
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\PayPeriod")
     ...
     *
     * @ORM\OneToOne(targetEntity="ShantsHRM\Entity\EmpDirectDebit", mappedBy="salary", cascade={"persist"})
     */
