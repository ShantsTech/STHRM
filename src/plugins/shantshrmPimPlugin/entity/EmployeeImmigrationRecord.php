...
use ShantsHRM\Entity\Decorator\EmployeeImmigrationRecordDecorator;
...
class EmployeeImmigrationRecord
{
     ...
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="immigrationRecords", cascade={"persist"})
