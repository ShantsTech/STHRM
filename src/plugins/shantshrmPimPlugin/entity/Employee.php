...
use ShantsHRM\Entity\Decorator\EmployeeDecorator;
 ...
 * @ORM\Entity
 * @ORM\EntityListeners({"ShantsHRM\Entity\Listener\EmployeeListener"})
 */
class Employee
{
    use DecoratorTrait;
     ...
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Nationality")
     ...
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\EmploymentStatus", inversedBy="employees")
     ...
     * @var JobTitle|null
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\JobTitle", inversedBy="employees")
     ...
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\JobCategory")
     ...
     * @var Subunit|null
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Subunit")
     ...
     *
     * @ORM\OneToOne(targetEntity="ShantsHRM\Entity\EmployeeTerminationRecord", cascade={"persist"})
     ...
     * @var Location[]
     *
     * @ORM\ManyToMany(targetEntity="ShantsHRM\Entity\Location", inversedBy="employees")
     * @ORM\JoinTable(
     ...
     * @var EmpDependent[]
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmpDependent", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmpEmergencyContact", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmployeeImmigrationRecord", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmpWorkExperience", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmployeeEducation", mappedBy="employee")
     */
     ...
     * @var EmployeeSkill[]
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmployeeSkill", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmployeeLanguage", mappedBy="employee")
     */
     ...
     * @var EmployeeLicense[]
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmployeeLicense", mappedBy="employee")
     */
     ...
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmployeeMembership", mappedBy="employee")
     */
     ...
     * @var EmployeeSalary[]
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmployeeSalary", mappedBy="employee")
     */
     ...
     * @var EmpContract[]
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmpContract", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmployeeAttachment", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\EmployeeTerminationRecord", mappedBy="employee")
     */
     ...
     * @var User[]
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\User", mappedBy="employee")
     */
     ...
     * @var EmpPicture|null
     *
     * @ORM\OneToOne(targetEntity="ShantsHRM\Entity\EmpPicture", mappedBy="employee")
     */
     ...
     * @var Employee[]
     *
     * @ORM\ManyToMany(targetEntity="ShantsHRM\Entity\Employee", mappedBy="supervisors")
     */
     ...
     * @var Employee[]
     *
     * @ORM\ManyToMany(targetEntity="ShantsHRM\Entity\Employee", inversedBy="subordinates")
     * @ORM\JoinTable(
     ...
     *
     * @ORM\OneToOne(targetEntity="ShantsHRM\Entity\EmpUsTaxExemption", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToOne(targetEntity="ShantsHRM\Entity\EmployeeWorkShift", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\AttendanceRecord", mappedBy="employee")
     */
