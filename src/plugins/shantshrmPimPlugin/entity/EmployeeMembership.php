...
use ShantsHRM\Entity\Decorator\EmployeeMembershipDecorator;
...
class EmployeeMembership
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="memberships", cascade={"persist"})
     ...
     * @var Membership
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Membership")
