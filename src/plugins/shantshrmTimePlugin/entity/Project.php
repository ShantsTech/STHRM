...
use ShantsHRM\Entity\Decorator\ProjectDecorator;
...
class Project
{
     ...
     * @var Customer
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Customer", inversedBy="projects", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="ShantsHRM\Entity\Employee", cascade={"persist", "remove"})
     * @ORM\JoinTable(
