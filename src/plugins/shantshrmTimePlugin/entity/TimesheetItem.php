...
use ShantsHRM\Entity\Decorator\TimesheetItemDecorator;
...
class TimesheetItem
{
     ...
     * @var Timesheet
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Timesheet")
     ...
     * @var Project
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Project")
     ...
     * @var ProjectActivity
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\ProjectActivity", inversedBy="timesheetItems")
