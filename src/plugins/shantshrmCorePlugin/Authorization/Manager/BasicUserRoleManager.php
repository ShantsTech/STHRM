...
use ShantsHRM\Core\Authorization\Dao\HomePageDao;
use ShantsHRM\Core\Authorization\Dto\DataGroupPermissionCollection;
use ShantsHRM\Core\Authorization\Dto\DataGroupPermissionFilterParams;
use ShantsHRM\Core\Authorization\Dto\ResourcePermission;
use ShantsHRM\Core\Authorization\Exception\AuthorizationException;
use ShantsHRM\Core\Authorization\Service\DataGroupService;
use ShantsHRM\Core\Authorization\Service\ScreenPermissionService;
use ShantsHRM\Core\Authorization\UserRole\AbstractUserRole;
use ShantsHRM\Core\Exception\CoreServiceException;
use ShantsHRM\Core\Exception\DaoException;
use ShantsHRM\Core\HomePage\HomePageEnablerInterface;
use ShantsHRM\Core\Service\AccessFlowStateMachineService;
use ShantsHRM\Core\Service\MenuService;
use ShantsHRM\Core\Traits\ClassHelperTrait;
use ShantsHRM\Core\Traits\Service\MenuServiceTrait;
...
class BasicUserRoleManager extends AbstractUserRoleManager
{
    ...
    private function _init(): void
    {
        ...
        foreach ($configurations as $roleName => $roleObj) {
            $className = $this->getClassHelper()->getClass(
                $roleObj['class'],
                'ShantsHRM\\Core\\Authorization\\UserRole\\'
            );
    ...
    public function getModuleDefaultPage(string $module): ?string
    {
        ...
        foreach ($defaultPages as $defaultPage) {
            ...
            $fallbackNamespace = 'ShantsHRM\\Core\\HomePage\\';
