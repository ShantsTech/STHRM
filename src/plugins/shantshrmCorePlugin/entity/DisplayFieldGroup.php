...
class DisplayFieldGroup
{
     ...
     * @var ReportGroup
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\ReportGroup")
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\SelectedDisplayFieldGroup", mappedBy="displayFieldGroup")
     */
