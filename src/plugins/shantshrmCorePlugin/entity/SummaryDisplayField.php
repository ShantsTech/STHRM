...
class SummaryDisplayField
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\DisplayFieldGroup")
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\SelectedGroupField", mappedBy="summaryDisplayField")
     */
