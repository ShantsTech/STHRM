...
use ShantsHRM\Entity\Decorator\UserDecorator;
...
class User
{
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee", inversedBy="users")
     ...
     * @var UserRole
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\UserRole")
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\UserAuthProvider", mappedBy="user")
     */
