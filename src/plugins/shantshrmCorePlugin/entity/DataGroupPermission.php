...
class DataGroupPermission
{
     ...
     * @var DataGroup
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\DataGroup", inversedBy="dataGroupPermissions")
     ...
     * @var UserRole
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\UserRole", cascade={"persist"})
