...
namespace ShantsHRM\Core\Report\DisplayField;
...
class GenericDateDisplayField extends CombinedDisplayField
{
    ...
    /**
     * @param \ShantsHRM\Entity\DisplayField $displayField
     */
    public function setDisplayField(\ShantsHRM\Entity\DisplayField $displayField): void
    {
