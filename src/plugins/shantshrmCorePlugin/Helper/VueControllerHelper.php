...
use ShantsHRM\Entity\MenuItem;
use ShantsHRM\Entity\Module;
...
class VueControllerHelper
{
    ...
    private function getThemeData(): array
    {
        ...
        $clientBannerUrl = $this->getRequest()->getBasePath()
            . '/images/shantshrm-logo.png?' . $this->getAssetsVersion();
