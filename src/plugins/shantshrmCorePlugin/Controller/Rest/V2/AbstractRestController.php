...
use ShantsHRM\Framework\Http\Request as HttpRequest;
use ShantsHRM\Framework\Http\Response as HttpResponse;
...
abstract class AbstractRestController extends AbstractController
{
    ...
    public function handle(HttpRequest $httpRequest): HttpResponse
    {
        ...
        try {
            ...
            // \ShantsHRM\Core\Subscriber\ApiAuthorizationSubscriber::onExceptionEvent
            throw $e;
        } catch (Exception $e) {
