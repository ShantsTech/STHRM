...
use ShantsHRM\Core\Dao\ReportGeneratorDao;
use ShantsHRM\Core\Dto\FilterParams;
use ShantsHRM\Core\Report\DisplayField\BasicDisplayField;
use ShantsHRM\Core\Report\DisplayField\CombinedDisplayField;
use ShantsHRM\Core\Report\DisplayField\EntityAliasMapping;
use ShantsHRM\Core\Report\DisplayField\GenericBasicDisplayField;
use ShantsHRM\Core\Report\DisplayField\GenericDateDisplayField;
use ShantsHRM\Core\Report\DisplayField\ListableDisplayField;
use ShantsHRM\Core\Report\DisplayField\NormalizableDTO;
use ShantsHRM\Core\Report\DisplayField\Stringable;
use ShantsHRM\Core\Report\FilterField\FilterField;
use ShantsHRM\Core\Report\FilterField\ValueXModifiable;
use ShantsHRM\Core\Report\FilterField\ValueYModifiable;
use ShantsHRM\Core\Report\Header\Column;
use ShantsHRM\Core\Report\Header\Header;
use ShantsHRM\Core\Report\Header\HeaderData;
use ShantsHRM\Core\Report\Header\StackedColumn;
use ShantsHRM\Core\Report\ReportSearchFilterParams;
use ShantsHRM\Core\Traits\ORM\EntityManagerHelperTrait;
use ShantsHRM\Entity\AbstractDisplayField;
use ShantsHRM\Entity\CompositeDisplayField;
use ShantsHRM\Entity\DisplayField;
use ShantsHRM\Entity\Employee;
use ShantsHRM\Entity\Report;
use ShantsHRM\Entity\SelectedFilterField;
use ShantsHRM\Entity\SummaryDisplayField;
...
class ReportGeneratorService
{
    ...
    protected function getReportDataQueryBuilder(ReportSearchFilterParams $filterParams): array
    {
        ...
        foreach ($displayFields as $displayField) {
            ...
            if ($displayFieldClass instanceof \ShantsHRM\Core\Report\DisplayField\DisplayField) {
