...
use ShantsHRM\Core\Utility\Mailer;
use ShantsHRM\Core\Utility\MailMessage;
use ShantsHRM\Core\Utility\MailTransport;
use ShantsHRM\Entity\EmailConfiguration;
use ShantsHRM\Entity\EmailTemplate;
...
class EmailService
{
    ...
    public function getMessage()
    {
        ...
        if (empty($this->messageFrom)) {
            ...
            $this->messageFrom = [$this->getEmailConfig()->getSentAs() => "ShantsHRM"];
        }
    ...
    public function sendTestEmail(string $toEmail): bool
    {
        ...
        $body = "This email confirms that $type details set in ShantsHRM ";
