...
use ShantsHRM\Entity\Decorator\LeaveEntitlementDecorator;
...
class LeaveEntitlement
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\Employee")
     ...
     * @var LeaveType
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\LeaveType", inversedBy="leaveEntitlement")
     ...
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\LeaveEntitlementType")
     ...
     * @var User
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\User")
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\LeaveLeaveEntitlement", mappedBy="entitlement")
     */
