...
use ShantsHRM\Entity\Decorator\LeaveDecorator;
...
class Leave
{
     ...
     * @var LeaveRequest
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\LeaveRequest", inversedBy="leaves")
     ...
     * @var LeaveType
     *
     * @ORM\ManyToOne(targetEntity="ShantsHRM\Entity\LeaveType")
     ...
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\LeaveLeaveEntitlement", mappedBy="leave")
     */
