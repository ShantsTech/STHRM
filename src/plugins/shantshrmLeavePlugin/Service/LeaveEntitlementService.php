...
use ShantsHRM\Leave\Dao\LeaveEntitlementDao;
use ShantsHRM\Leave\Entitlement\EntitlementConsumptionStrategy;
use ShantsHRM\Leave\Entitlement\FIFOEntitlementConsumptionStrategy;
...
class LeaveEntitlementService
{
    ...
    public function getLeaveEntitlementStrategy(): EntitlementConsumptionStrategy
    {
        if (!$this->leaveEntitlementStrategy instanceof EntitlementConsumptionStrategy) {
            ...
            $strategyClass = $this->getClassHelper()->getClass($strategyClass, 'ShantsHRM\\Leave\\Entitlement\\');
