...
{
    /**
     * @see \ShantsHRM\Leave\Event\LeaveApply
     */
    public const APPLY = 'leave.apply';

    /**
     * @see \ShantsHRM\Leave\Event\LeaveAssign
     */
    public const ASSIGN = 'leave.assign';

    /**
     * @see \ShantsHRM\Leave\Event\LeaveApprove
     */
    public const APPROVE = 'leave.approve';

    /**
     * @see \ShantsHRM\Leave\Event\LeaveCancel
     */
    public const CANCEL = 'leave.cancel';

    /**
     * @see \ShantsHRM\Leave\Event\LeaveReject
     */
