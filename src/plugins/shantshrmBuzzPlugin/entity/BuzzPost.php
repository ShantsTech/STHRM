...
use ShantsHRM\Entity\Decorator\BuzzPostDecorator;
...
class BuzzPost
{
     ...
     * @var BuzzPhoto[]
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\BuzzPhoto", mappedBy="post")
     */
     ...
     * @var BuzzLink[]
     *
     * @ORM\OneToMany(targetEntity="ShantsHRM\Entity\BuzzLink", mappedBy="post")
     */
