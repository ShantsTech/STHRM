...
use ShantsHRM\Buzz\Api\Model\BuzzFeedPostModel;
use ShantsHRM\Buzz\Api\Model\BuzzPostModel;
use ShantsHRM\Buzz\Api\ValidationRules\BuzzVideoLinkValidationRule;
use ShantsHRM\Buzz\Dto\BuzzFeedFilterParams;
use ShantsHRM\Buzz\Dto\BuzzFeedPost;
...
use ShantsHRM\Core\Dto\Base64Attachment;
...
use ShantsHRM\Entity\BuzzLink;
use ShantsHRM\Entity\BuzzPhoto;
use ShantsHRM\Entity\BuzzPost;
...
class BuzzPostAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={ShantsHRM\Buzz\Api\BuzzPostAPI::MODEL_DEFAULT_POST, ShantsHRM\Buzz\Api\BuzzPostAPI::MODEL_DETAILED_POST},
     *             default=ShantsHRM\Buzz\Api\BuzzPostAPI::MODEL_DEFAULT_POST
     *         )
     *     ),
     *     @OA\RequestBody(
     *         @OA\JsonContent(
