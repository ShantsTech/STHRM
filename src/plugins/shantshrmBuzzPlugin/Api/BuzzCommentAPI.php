...
use Exception;
use ShantsHRM\Buzz\Api\Model\BuzzCommentModel;
use ShantsHRM\Buzz\Api\Model\BuzzDetailedCommentModel;
use ShantsHRM\Buzz\Dto\BuzzCommentSearchFilterParams;
...
class BuzzCommentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={ShantsHRM\Buzz\Api\BuzzCommentAPI::MODEL_DEFAULT, ShantsHRM\Buzz\Api\BuzzCommentAPI::MODEL_DETAILED},
     *             default=ShantsHRM\Buzz\Api\BuzzCommentAPI::MODEL_DEFAULT
     *         )
     *     ),
     *     @OA\Response(
     *         response="200",
