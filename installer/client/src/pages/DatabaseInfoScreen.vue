...
<template>
  ...
  >
    ...
    <br />
    <Notice title="important" class="shantshrm-installer-page-notice">
      <oxd-text tag="p" class="shantshrm-installer-page-content">
        Make sure it's a copy of the database of your current ShantsHRM
    ...
    <br />
    <Notice title="encryption" class="shantshrm-installer-page-notice">
      <oxd-text tag="p" class="shantshrm-installer-page-content">
