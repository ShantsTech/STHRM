 ...
 */
 -->
<template>
  <oxd-form class="shantshrm-installer-page" @submit="toggleModal">
    <oxd-text tag="h5" class="shantshrm-installer-page-title">
      Welcome to ShantsHRM Starter Version {{ productversion }} Setup Wizard
    </oxd-text>
    <br />
    <oxd-text tag="p" class="shantshrm-installer-page-content">
      This setup wizard will guide through the steps necessary to install/
      upgrade ShantsHRM Starter components and their dependencies.
    </oxd-text>
    <br />
    <oxd-text tag="p" class="shantshrm-installer-page-content">
    ...
    <br />
    <oxd-form-row class="shantshrm-installer-page-row">
      <oxd-radio-input
        v-model="selected"
        value="install"
        option-label="Fresh Installation"
      />
      <oxd-text tag="p" class="shantshrm-installer-page-content --label">
        Choose this option if you are installing ShantsHRM Starter for the first
        time
      </oxd-text>
    </oxd-form-row>
    ...
    <oxd-form-row class="shantshrm-installer-page-row">
      ...
      />
      <oxd-text tag="p" class="shantshrm-installer-page-content --label">
        Choose this option if you are already using a prior version of ShantsHRM
