...
use ShantsHRM\Core\Utility\KeyHandler;
use ShantsHRM\Core\Utility\PasswordHash;
use ShantsHRM\Framework\Filesystem\Filesystem;
use ShantsHRM\Installer\Migration\V3_3_3\Migration;
...
class AppSetupUtility
{
    public const MIGRATIONS_MAP = [
        ...
        '4.0' => \ShantsHRM\Installer\Migration\V4_0\Migration::class,
        '4.1' => \ShantsHRM\Installer\Migration\V4_1\Migration::class,
        '4.1.1' => \ShantsHRM\Installer\Migration\V4_1_1\Migration::class,
        '4.1.2' => \ShantsHRM\Installer\Migration\V4_1_2\Migration::class,
        '4.1.2.1' => \ShantsHRM\Installer\Migration\V4_1_2_1\Migration::class,
        '4.2' => \ShantsHRM\Installer\Migration\V4_2\Migration::class,
        '4.2.0.1' => \ShantsHRM\Installer\Migration\V4_2_0_1\Migration::class,
        '4.3' => \ShantsHRM\Installer\Migration\V4_3\Migration::class,
        '4.3.1' => \ShantsHRM\Installer\Migration\V4_3_1\Migration::class,
        '4.3.2' => \ShantsHRM\Installer\Migration\V4_3_2\Migration::class,
        '4.3.3' => \ShantsHRM\Installer\Migration\V4_3_3\Migration::class,
        '4.3.4' => \ShantsHRM\Installer\Migration\V4_3_4\Migration::class,
        '4.3.5' => \ShantsHRM\Installer\Migration\V4_3_5\Migration::class,
        '4.4' => \ShantsHRM\Installer\Migration\V4_4_0\Migration::class,
        '4.5' => \ShantsHRM\Installer\Migration\V4_5_0\Migration::class,
        '4.6' => \ShantsHRM\Installer\Migration\V4_6_0\Migration::class,
        '4.6.0.1' => \ShantsHRM\Installer\Migration\V4_6_0_1\Migration::class,
        '4.7' => \ShantsHRM\Installer\Migration\V4_7_0\Migration::class,
        '4.8' => \ShantsHRM\Installer\Migration\V4_8_0\Migration::class,
        '4.9' => \ShantsHRM\Installer\Migration\V4_9_0\Migration::class,
        '4.10' => \ShantsHRM\Installer\Migration\V4_10_0\Migration::class,
        '4.10.1' => \ShantsHRM\Installer\Migration\V4_10_1\Migration::class,
        '5.0' => [
            \ShantsHRM\Installer\Migration\V5_0_0_beta\Migration::class,
            \ShantsHRM\Installer\Migration\V5_0_0\Migration::class,
        ],
        '5.1' => \ShantsHRM\Installer\Migration\V5_1_0\Migration::class,
        '5.2' => \ShantsHRM\Installer\Migration\V5_2_0\Migration::class,
        '5.3' => \ShantsHRM\Installer\Migration\V5_3_0\Migration::class,
    ];
