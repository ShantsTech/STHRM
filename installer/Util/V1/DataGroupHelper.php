...
namespace ShantsHRM\Installer\Util\V1;

use Doctrine\DBAL\Connection;
use Doctrine\DBAL\ParameterType;
use ShantsHRM\Installer\Util\V1\Dto\Api;
use ShantsHRM\Installer\Util\V1\Dto\DataGroup;
use ShantsHRM\Installer\Util\V1\Dto\Screen;
