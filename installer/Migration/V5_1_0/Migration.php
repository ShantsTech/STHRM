...
namespace ShantsHRM\Installer\Migration\V5_1_0;
...
class Migration extends AbstractMigration
{
    ...
    private function updateRecruitmentMenuItems(): void
    {
        $this->updateMenuConfigurator(
            'recruitment',
            'addJobVacancy',
            'ShantsHRM\\Recruitment\\Menu\\VacancyMenuConfigurator'
        );
        $this->updateMenuConfigurator(
            'recruitment',
            'addCandidate',
            'ShantsHRM\\Recruitment\\Menu\\CandidateMenuConfigurator'
        );
        $this->updateMenuConfigurator(
            'recruitment',
    ...
    private function updatePerformanceMenuItems(): void
    {
        $this->updateMenuConfigurator(
            'performance',
            'saveKpi',
            'ShantsHRM\\Performance\\Menu\\KpiMenuConfigurator'
        );
        $this->updateMenuConfigurator(
            'performance',
            'addPerformanceTracker',
            'ShantsHRM\\Performance\\Menu\\PerformanceTrackerMenuConfigurator'
        );
        $this->updateMenuConfigurator(
            'performance',
            'addPerformanceTrackerLog',
            'ShantsHRM\\Performance\\Menu\\PerformanceTrackerLogMenuConfigurator'
        );
        $this->updateMenuConfigurator(
            'performance',
            'saveReview',
            'ShantsHRM\\Performance\\Menu\\ManageReviewMenuConfigurator'
        );
        $this->updateMenuConfigurator(
            'performance',
            'reviewEvaluate',
            'ShantsHRM\\Performance\\Menu\\MyReviewMenuConfigurator'
        );
        $this->updateMenuConfigurator(
            'performance',
            'reviewEvaluateByAdmin',
            'ShantsHRM\\Performance\\Menu\\AdminReviewMenuConfigurator'
        );
    }
}
