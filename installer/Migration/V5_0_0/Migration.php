...
namespace ShantsHRM\Installer\Migration\V5_0_0;
...
class Migration extends AbstractMigration
{
    ...
    public function up(): void
    {
        ...
        $this->updateMenuConfigurator('attendance', null, 'ShantsHRM\\Attendance\\Menu\\AttendanceMenuConfigurator');
        ...
        $this->updateMenuConfigurator('admin', 'saveJobTitle', 'ShantsHRM\\Admin\\Menu\\JobTitleMenuConfigurator');
        $this->updateMenuConfigurator('admin', 'saveLocation', 'ShantsHRM\\Admin\\Menu\\LocationMenuConfigurator');
        $this->updateMenuConfigurator('admin', 'payGrade', 'ShantsHRM\\Admin\\Menu\\PayGradeConfigurator');
        $this->updateMenuConfigurator('admin', 'saveSystemUser', 'ShantsHRM\\Admin\\Menu\\UserMenuConfigurator');

        $this->updateMenuConfigurator('pim', 'viewMyDetails', 'ShantsHRM\\Pim\\Menu\\MyInfoMenuConfigurator');
        $this->updateMenuConfigurator(
            'pim',
            'definePredefinedReport',
            'ShantsHRM\\Pim\\Menu\\PimReportMenuConfigurator'
        );
        $this->updateMenuConfigurator(
            'pim',
        ...
        $this->updateMenuConfigurator('leave', 'defineLeaveType', 'ShantsHRM\\Leave\\Menu\\LeaveTypeMenuConfigurator');
        $this->updateMenuConfigurator(
            'leave',
            'viewLeaveRequest',
            'ShantsHRM\\Leave\\Menu\\DetailedLeaveRequestMenuConfigurator'
        );

        $this->updateMenuConfigurator('time', 'addCustomer', 'ShantsHRM\\Time\\Menu\\CustomerMenuConfigurator');
        $this->updateMenuConfigurator('time', 'saveProject', 'ShantsHRM\\Time\\Menu\\ProjectMenuConfigurator');
        $this->updateMenuConfigurator(
            'time',
            'displayProjectActivityDetailsReport',
            'ShantsHRM\\Time\\Menu\\DetailedProjectActivityReportMenuConfigurator'
        );
