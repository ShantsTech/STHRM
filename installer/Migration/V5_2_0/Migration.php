...
namespace ShantsHRM\Installer\Migration\V5_2_0;
...
class Migration extends AbstractMigration
{
    ...
    public function up(): void
    {
        ...
        $this->getConfigHelper()->setConfigValue('help.url', 'https://starterhelp.hrm.shants-tech.com');
        ...
        $this->getConfigHelper()->deleteConfigValue('https://opensourcehelp.hrm.shants-tech.com');
    ...
    private function updatePimLeftMenuConfigurators(): void
    {
        $qb = $this->createQueryBuilder()
            ...
            ->setParameter('menuConfiguratorClassName', 'ShantsHRM\\Pim\\Menu\\PIMLeftMenuItemConfigurator')
