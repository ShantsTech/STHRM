...
INSERT INTO `hs_hr_module` VALUES ('MOD001','Admin','ShantsHRM','info@hrm.shants-tech.com','VER001','HR Admin'),
								  ('MOD002','PIM','ShantsHRM','info@hrm.shants-tech.com','VER001','HR Functions'),
								  ('MOD004','Report','ShantsHRM','info@hrm.shants-tech.com','VER001','Reporting'),
								  ('MOD005', 'Leave', 'ShantsHRM', 'info@hrm.shants-tech.com', 'VER001', 'Leave Tracking'),
								  ('MOD006', 'Time', 'ShantsHRM', 'info@hrm.shants-tech.com', 'VER001', 'Time Tracking'),
								  ('MOD007', 'Benefits', 'ShantsHRM', 'info@hrm.shants-tech.com', 'VER001', 'Benefits Tracking'),
 	 							('MOD008', 'Recruitment', 'ShantsHRM', 'info@hrm.shants-tech.com', 'VER001', 'Recruitment'),
 	 							('MOD009', 'Performance', 'ShantsHRM', 'info@hrm.shants-tech.com', 'VER001', 'Performance');
...
INSERT INTO ohrm_email_template(`id`, `email_id`, `locale`, `performer_role`, `recipient_role`,`body`, `subject`) VALUES 
    (1, 1, 'en_US', NULL, 'supervisor', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/apply/leaveApplicationBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/apply/leaveApplicationSubject.txt'),
    (2, 1, 'en_US', NULL, 'subscriber', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/apply/leaveApplicationSubscriberBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/apply/leaveApplicationSubject.txt'),
    (3, 3, 'en_US', NULL, 'ess', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/approve/leaveApprovalBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/approve/leaveApprovalSubject.txt'),
    (4, 3, 'en_US', NULL, 'subscriber', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/approve/leaveApprovalSubscriberBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/approve/leaveApprovalSubscriberSubject.txt'),
    (5, 2, 'en_US', NULL, 'ess', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentSubject.txt'),
    (6, 2, 'en_US', NULL, 'supervisor', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentBodyForSupervisors.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentSubjectForSupervisors.txt'),
    (7, 2, 'en_US', NULL, 'subscriber', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentSubscriberBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentSubscriberSubject.txt'),
    (8, 4, 'en_US', 'ess', 'supervisor', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveEmployeeCancellationBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveEmployeeCancellationSubject.txt'),
    (9, 4, 'en_US', 'ess', 'subscriber', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveEmployeeCancellationSubscriberBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveEmployeeCancellationSubscriberSubject.txt'),
    (10, 4, 'en_US', NULL, 'ess', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveCancellationBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveCancellationSubject.txt'),
    (11, 4, 'en_US', NULL, 'subscriber', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveCancellationSubscriberBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveCancellationSubscriberSubject.txt'),
    (12, 5, 'en_US', NULL, 'ess', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/reject/leaveRejectionBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/reject/leaveRejectionSubject.txt'),
    (13, 5, 'en_US', NULL, 'subscriber', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/reject/leaveRejectionSubscriberBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/reject/leaveRejectionSubscriberSubject.txt'),
    (14, 6, 'en_US', NULL, 'ess', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/change/leaveChangeBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/change/leaveChangeSubject.txt'),
    (15, 6, 'en_US', NULL, 'subscriber', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/change/leaveChangeSubscriberBody.txt', 'shantshrmLeavePlugin/modules/leave/templates/mail/en_US/change/leaveChangeSubscriberSubject.txt');
