...
namespace ShantsHRM\Installer\Controller\Installer;
...
use ShantsHRM\Installer\Controller\AbstractInstallerVueController;
...
class InstallerCompleteController extends AbstractInstallerVueController
{
    ...
    public function preRender(Request $request): void
    {
        ...
        Logger::getLogger()->info(
            'ShantsHRM ' . Config::PRODUCT_VERSION . ' status: ' . var_export(Config::isInstalled(), true)
        );
    }
}
