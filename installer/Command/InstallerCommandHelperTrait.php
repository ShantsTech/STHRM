...
trait InstallerCommandHelperTrait
{
    ...
    private function drawSystemCheckTable(array $systemCheckResults): void
    {
        ...
        $this->getIO()->block(
            'In order for your ShantsHRM installation to function properly, please ensure that all of the system check items listed below are green. If any are red, please take the necessary steps to fix them.'
        );
